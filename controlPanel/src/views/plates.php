...
<head>
    ...
    <link rel="stylesheet" href="/mesonmontesdetoledo.com/controlPanel/public/css/platesControlPanel.css">

    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>

    <script src="/mesonmontesdetoledo.com/controlPanel/public/js/platesControlPanel.js"></script>
    ...
    <div id="centerContainer">
        ...
        <section>
            <div id="informationContainer">
                <?php require_once(ROOT . "controlPanel/src/controllers/platesControlPanelController.php"); ?>
            </div>
        </section>
    </div>
