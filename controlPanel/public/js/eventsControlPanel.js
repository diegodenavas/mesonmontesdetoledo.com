window.onload = function() {
    ...
    addButton.click(function() {
        ...
        $("#recordFormEvent").attr("action", "/mesonmontesdetoledo.com/controlPanel/src/controllers/updateEventController.php");
    ...
    deleteButton.click(function() {
        $("#modalWindowEvent").fadeIn(150);
        $("#recordFormEvent").attr("action", "/mesonmontesdetoledo.com/controlPanel/src/controllers/deleteEventController.php");
        let id = $(this).parent().siblings(".inputId").val();
    ...
    function closeForm() {
        ...
        $("#recordFormEvent").attr("action", "/mesonmontesdetoledo.com/controlPanel/src/controllers/");
