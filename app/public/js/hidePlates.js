window.onload = function(){
    ...
    $(".categoryTitle").click(function(e) {
        ...
        if(display == "none"){
            ...
            $(this).find(".menuCategoryArrowIcon").attr("src", "/mesonmontesdetoledo.com/app/public/images/webIcons/despliegue2.png");
            $('html, body').animate({scrollTop: $(this).offset().top - heightMenu});
        }else{
            $(this).siblings(".platesContainer").slideUp();
            $(this).find(".menuCategoryArrowIcon").attr("src", "/mesonmontesdetoledo.com/app/public/images/webIcons/despliegue.png");
        }
    })
