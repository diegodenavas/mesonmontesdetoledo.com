window.onload = function() {
    ...
    function changeImage() {
        $(".rightArrowGallery").click(function() {
            ...
            if(galleryId == "gallery1img"){
                ...
                index1++;
                $("#gallery1img").css("background-image", "url('/mesonmontesdetoledo.com/app/public/images/gallery/" + gallery1[index1] + "')");
                
            }
            else if(galleryId == "gallery2img"){
                if (index2 == gallery2.length - 1) index2 = 0;
                index2++;
                $("#gallery2img").css("background-image", "url('/mesonmontesdetoledo.com/app/public/images/gallery/" + gallery2[index2] + "')");
            }
            else{
                if (index3 == gallery3.length - 1) index3 = 0;
                index3++;
                $("#gallery3img").css("background-image", "url('/mesonmontesdetoledo.com/app/public/images/gallery/" + gallery3[index3] + "')");
            }
        });
    ...
    function arrowsHover() {
        $(".rightArrowGallery").mouseover(function() {
            $(this).attr("src", "/mesonmontesdetoledo.com/app/public/images/webIcons/rightArrowHover.png");
        }).mouseout(function() {
            $(this).attr("src", "/mesonmontesdetoledo.com/app/public/images/webIcons/rightArrow.png");
        });
    
    
        $(".leftArrowGallery").mouseover(function() {
            $(this).attr("src", "/mesonmontesdetoledo.com/app/public/images/webIcons/leftArrowHover.png");
        }).mouseout(function() {
            $(this).attr("src", "/mesonmontesdetoledo.com/app/public/images/webIcons/leftArrow.png");
        });
    }
