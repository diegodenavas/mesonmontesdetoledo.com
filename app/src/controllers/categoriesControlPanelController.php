...
foreach ($plateCategoriesList as $plateCategory) {        
    ...
    "<tr>
        ...
        <td><img src='/mesonmontesdetoledo.com/public/images/platesIcons/" . $plateCategory->getIconRoot() . "' class='categoriesIcons'></td>
        <td>
...
require_once(ROOT . "app/src/includes/categoriesControlPanelForms.php");
?>