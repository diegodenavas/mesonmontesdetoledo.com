...
<head>
    ...
    <script src="/mesonmontesdetoledo.com/public/js/registerUser.js"></script>
...
<body>
    ...
    <section>
        <div class='formContainer'>
            <form action="/mesonmontesdetoledo.com/app/src/controllers/registerController.php" method='POST' id='formRegister'>
